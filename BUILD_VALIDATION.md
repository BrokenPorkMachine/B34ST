# FBR34KER 0.4.4b Beta validation

Validation date: 2026-06-28

## Result

The 0.4.4b Beta release preparation passed the canonical non-QEMU gate, the
...
- The release manifest contains 72 artifacts and identifies version `0.4.4b`,
  channel `beta`, source ID `0.4.4b-beta`, and release root
  `FBR34KER_0.4.4b_Beta`.
...
- `FBR34KER_0.4.4b_Beta_source.zip`
- `FBR34KER_0.4.4b_Beta_complete.zip`
- `FBR34KER_0.4.4b_Beta_sdk.zip`
- `FBR34KER_0.4.4b_Beta_operational.zip`
