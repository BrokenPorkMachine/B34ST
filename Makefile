...
manifest: all generic hardware-probe modules loader-check loader-conformance-test sdk generic-loader deployment-simulate apple-boot-images apple-bringup-simulate physical-integration-simulate physical-validation-candidate
