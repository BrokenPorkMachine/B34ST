# FBR34KER 0.4.1 Beta release notes

FBR34KER 0.4.1 Beta is a patch release based on the merged 0.4.0 Beta tree. It
...
0.4.1 does not change the public binary interfaces:
...
The 0.4.1 source is gated by release-version consistency checks, isolated host
