...
```
FBR34KER 0.4.0-beta — environment diagnostics
  [OK]   clang — found
  [OK]   ld.lld — found
...
```
FBR34KER 0.4.0 (beta)
Target: qemu_virt; source: 0.4.0-beta
...
```
FBR34KER B34ST v0.4.0 — Unified Multi-Tool Control Panel
...
| Archive | Contents |
|---|---|
| `FBR34KER_0.4.0_Beta_operational.zip` | Public release — no private code |
...
| Archive | Contents |
|---|---|
| `FBR34KER_0.4.0_Beta_source.zip` | All source code, docs, scripts (excludes build artifacts) |
| `FBR34KER_0.4.0_Beta_complete.zip` | Source + all build artifacts, SDK, boot images, simulations |
...
| `docs/B34ST_TASKS.md` | Historical B34ST task list (all complete as of 0.4.0) |
