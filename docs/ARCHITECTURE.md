...
Version 0.3.0 includes bounded in-memory models for patch, boot-policy, and
...
Version 0.3.0 retains an allocation-free orchestration layer with fixed compile-time capacities.
