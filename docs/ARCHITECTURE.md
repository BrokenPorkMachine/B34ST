...
Version 0.4.5b includes bounded in-memory models for patch, boot-policy, and
...
Version 0.4.5b retains an allocation-free orchestration layer with fixed compile-time capacities.
