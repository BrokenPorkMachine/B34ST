...
Version 0.5.0b includes bounded in-memory models for patch, boot-policy, and
...
Version 0.5.0b retains an allocation-free orchestration layer with fixed compile-time capacities.
