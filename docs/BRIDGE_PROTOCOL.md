...
FBR34KER 0.4.1 adds a persistent bridge for an operator-controlled first-stage environment. It is a bounded transport contract, not a device-entry mechanism.
