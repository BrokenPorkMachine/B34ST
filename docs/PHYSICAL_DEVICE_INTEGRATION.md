...
Version 0.6.2b prepares FBR34KER for an authorized, user-owned A12/A12X/A12Z/A13 test device without embedding an exploit, signature bypass, or stock-iBoot patch.
...
Every 0.6.2b session ZIP contains:
