...
def main():
    ...
    summary={'schema_version':1,'project':'FBR34KER','release_version':'0.4.2b','success':success['passed'],'failure_observed':not failed['passed'],'reset_invalidated_authorization':failed['authorization_invalidated_after_recovery'],'recovered_after_reauthorization':recovered['passed']}
