...
class SessionToolsTests(unittest.TestCase):
    def bundle(self,path):
        summary={'schema_version':1,'project':'FBR34KER','release_version':'0.4.3b','session_id':'1'*24,'profile_id':'p','device':{},'adapter':{},'image':{},'stages':[{'stage':'console','status':'passed'}],'passed':True}
